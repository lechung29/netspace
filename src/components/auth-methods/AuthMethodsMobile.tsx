...
const AuthMethodsMobile: React.FunctionComponent = () => {
    return (
        <StyledWrapper>
            <ul className="g-auth-method-mobile">
                <li className="g-auth-method-icon facebook">
                ...
                <li className="g-auth-method-icon twitter">
                ...
                <li className="g-auth-method-icon github">
